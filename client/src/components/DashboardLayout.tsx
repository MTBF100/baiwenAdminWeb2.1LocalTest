...
const menuItems = [
  ...
  { icon: FileText, label: "文章管理", path: "/articles" },
  { icon: CalendarDays, label: "活动管理", path: "/activities" },
  { icon: BarChart3, label: "数据分析", path: "/analytics" },
  { icon: RefreshCw, label: "数据同步", path: "/sync" },
  { icon: ScrollText, label: "系统日志", path: "/logs" },
];
      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          ...
          <Button
            ...
            size="lg"
            className="w-full shadow-lg hover:shadow-xl transition-all bg-[#ce1126] hover:bg-[#b91c2c]"
          >
            登录
          </Button>
        </div>
